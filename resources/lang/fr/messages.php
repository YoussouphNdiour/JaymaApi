<?php return array (
  ...
  'Store is required when banner type is store wise' => 'Le magasin est requis lorsque le type de bannière concerne le magasin.',
  ...
  'Role name already taken!' => 'Nom de rôle déjà pris !',
  ...
  'Import Item`s File' => 'Importer le fichier de l\'article',
  ...
  'Schedule order slot duration' => 'Planifier la durée du créneau de commande',
  'Digit after decimal point' => 'Chiffre après la virgule',
  'minute' => 'Minute',
  ...
  'Store can serve in' => 'Le magasin peut servir dans',
  'One Zone' => 'Une zone',
  ...
  'Delivery Man Not Found' => 'Livreur introuvable',
  ...
  'STEP 3' => 'STEP 3',
  'Select Data Type' => 'Sélectionnez le type de données',
  'Select Data Range and Export' => 'Sélectionnez la plage de données et exportez',
  'clear' => 'Clear',
  ...
  'Select Data Range by Date or ID and Export' => 'Sélectionnez la plage de données par date ou ID et exportez',
  ...
  '* This discount is applied on all the foods in your restaurant' => '*Cette réduction est appliquée sur tous les aliments de votre restaurant',
  ...
  'Ex_:_Footer_Text' => 'Ex : Texte de pied de page',
  ...
  'Ratio (1:1)' => 'Ratio (1:1)',
  'Employee image size max 2 MB' => 'Taille de l\'image de l\'employé : 2 Mo maximum',
  ...
  'Click this icon to start pin points in the map and connect them to draw a zone . Minimum 3  points required' => 'Cliquez sur cette icône pour démarrer des points d\'épingle sur la carte et les connecter pour dessiner une zone.',
  'Coordinates' => 'Coordinates',
  'Minimum delivery charge' => 'Frais de livraison minimum',
  'Ex:' => 'Ex:',
  'Delivery charge per KM' => 'Frais de livraison par KM',
  ...
  '1. Download the format file and fill it with proper data.' => '1. Téléchargez le fichier de format et remplissez-le avec les données appropriées.',
  '2. You can download the example file to understand how the data must be filled.' => '2. Vous pouvez télécharger le fichier exemple pour comprendre comment les données doivent être renseignées.',
  '3. Once you have downloaded and filled the format file  upload it in the form below and
                        ...
                        submit.',
  '4. After uploading categories you need to edit them and set category`s images.' => '4. Après avoir téléchargé les catégories, vous devez les modifier et définir les images de la catégorie.',
  ...
  '4. You can get store id  module id and unit id from their list  please input the right ids.' => '4. Vous pouvez obtenir l\'identifiant du module d\'identification du magasin et l\'identifiant de l\'unité à partir de leur liste, veuillez saisir les bons identifiants.',
  ...
  'Employee Edit' => 'Employé Modifier',
  ...
  '4. After uploading stores you need to edit them and set stores`s logo and cover.' => '4. Après avoir téléchargé les magasins, vous devez les modifier et définir le logo et la couverture des magasins.',
  ...
  'Search By Referance' => 'Recherche par référence',
  ...
  'Select Store' => 'Sélectionnez un magasin',
  ...
  '* This discount is applied on all the items in your store' => '*Cette réduction est appliquée sur tous les articles de votre boutique',
  'include_POS_in_store_panel' => 'Include POS in store panel',
  'collect_from' => 'Collect from',
  'Ex_:_Card' => 'Ex : Carte',
  'Ex_:_1000' => 'Ex : 1000',
  'history' => 'History',
  'Search By Referance  or Name' => 'Rechercher par référence ou par nom',
  'Ex : 5+ Characters' => 'Ex : 5+ caractéres',
  ...
  'Order cancellation is possible by the store if  Yes  is chosen .' => 'L\'annulation de commande est possible par le magasin si Oui est choisi.',
  ...
  'Maintenance is on.' => 'La maintenance est en cours.',
  'Maintenance is off.' => 'La maintenance est interrompue.',
  ...
  'desc' => 'Desc',
  'Ex: Jhone' => 'Ex: Jhone',
  'Login as Store Employee' => 'Connectez-vous en tant qu\'employé du magasin',
  'login here' => 'Login here',
  'Login as Store Owner' => 'Connectez-vous en tant que propriétaire du magasin',
  ...
  'If this option is enabled  the Delivery men Tip option will show on the user app & web app during order placement.' => 'Si cette option est activée, l\'option Pourboire des livreurs s\'affichera sur l\'application utilisateur et l\'application Web lors du passage de la commande.',
  'If this field is enabled  the delivery man is able to see the earnings when accepting the order on the order request page.' => 'Si ce champ est activé, le livreur peut voir les gains lors de l\'acceptation de la commande sur la page de demande de commande.',
  ...
  'If this field is active  customers have to provide a 4-digit code to the delivery man to deliver an order successfully. Customers will get this code in order details.' => 'Si ce champ est actif, les clients doivent fournir un code à 4 chiffres au livreur pour livrer une commande avec succès.',
  ...
  'If this field is active  stores can register themself using the restaurant app  user app  or website.' => 'Si ce champ est actif, les magasins peuvent s\'inscrire en utilisant l\'application utilisateur ou le site Web de l\'application de restaurant.',
  ...
  'If this field is active  stores can register themself using the store app  user app  or website.' => 'Si ce champ est actif, les magasins peuvent s\'inscrire à l\'aide de l\'application utilisateur ou du site Web de l\'application du magasin.',
  ...
  'Reason' => 'Raison',
  'Refund Reason Deleted Successfully' => 'Raison du remboursement supprimée avec succès',
  'Fatoorah' => 'Fatoorah',
  ...
  'Refund Rejection Successfully' => 'Rejet du remboursement avec succès',
  ...
  'Action' => 'Action',
  'Search by ID  customer or payment status' => 'Recherche par identifiant client ou statut de paiement',
  ...
  'Cash Payments' => 'Paiement en éspèces',
  'Digital Payments' => 'Paiements numériques',
  'delivery_charge_per_km' => 'Delivery charge per km',
  'Comission on delivery fee' => 'Commission sur frais de livraison',
  ...
  'Mart ' => 'Mart ',
  'Download' => 'Download',
  'Car provider' => 'Fournisseur de voiture',
  ...
  'Just write us a message!' => 'Écrivez-nous simplement un message !',
  'Call' => 'Appel',
  'Us' => 'Us',
  'Email' => 'Email',
  'Address' => 'Address',
  ...
  'Refunded amount added to customer wallet' => 'Montant remboursé ajouté au portefeuille client',
  'What' => 'What',
  's so' => 'S so',
  ...
  'Reviewer Brand' => 'Marque de l\'évaluateur',
  'Image' => 'Image',
  ...
  'Not_Seen_Yet' => 'Pas Vu Encore',
  'Message View' => 'Affichage des messages',
  'Message_View' => 'Affichage des messages',
  ...
  'Mail_Body' => 'Mail Body',
  'Reply_form_6amMart' => 'Formulaire de réponse Jayms',
  'Dear' => 'Cher',
  ...
  'Search by order_id' => 'Rechercher par order id',
  ...
  'New  Parcel System Module' => 'Nouveau module de système de colis',
  'cvb' => 'Cvb',
  'test mo' => 'Test mo',
  'Tech Mart' => 'Tech Mart',
  ...
  'Please select items from' => 'Veuillez sélectionner des éléments parmi',
  'Variation' => 'Variation',
  ...
  'Deliveryman Earning' => 'Gain Livreur',
  ...
  'Store Pending Requests' => 'Stocker les demandes en attente',
  'pending_requests' => 'Pending requests',
  'deny_requests' => 'Deny requests',
  'Store Deny Requests' => 'Demandes de refus de magasin',
  ...
  'Select Module & Monitor your business monitor wise' => 'Sélectionnez le module et surveillez votre entreprise par le biais du moniteur',
  'e-Pharma' => 'E-Pharma',
  ...
  'If the order is successfully refunded  the full order amount goes to this section without the delivery fee and delivery tips.' => 'Si la commande est remboursée avec succès, le montant total de la commande est versé dans cette section sans les frais de livraison ni les conseils de livraison.',
  'Deducting the admin discount from the admin net income amount goes to this section.' => 'La déduction de la remise administrative du montant du revenu net administratif va à cette section.',
  'If self-delivery is off  deducting delivery man earnings & admin commission order amount goes to store earnings otherwise deducting admin commission all order amount goes to this section.' => 'Si l\'auto-livraison est désactivée, en déduisant les revenus du livreur et le montant de la commande, la commission d\'administration est versée aux revenus du magasin. Sinon, en déduisant la commission d\'administration, tout le montant de la commande est versé dans cette section.',
  'Deducting the admin commission on the delivery fee  the delivery fee & tips amount goes to
                                        ...
                                        earning section.',
  'Include_TAX_Amount' => 'Inclure TAX Amount',
  ...
  'orders by Zone.' => 'Orders by Zone.',
  'Select Module & Monitor your business module wise' => 'Sélectionnez le module et surveillez votre module métier',
  ...
  'Default Commission on Order' => 'Commission par défaut sur commande',
  ...
  'Type' => 'Type',
  'Starting_coverage_area' => 'Zone de couverture debut',
  ...
  'Max_Number_of_Otp_Hits_in_a_Row' => 'Nombre maximum d\'accès Otp consécutifs',
  ...
  'Search by title or code' => 'Recherche par titre ou code',
  ...
  'Maximum delivery charge must be greater than minimum delivery charge.' => 'Les frais de livraison maximum doivent être supérieurs aux frais de livraison minimum.',
  ...
  'Delivery Service Section' => 'Section Service de livraison',
  'Title' => 'Title',
  ...
  'Service Id file' => 'Fichier d\'identification du service',
  'Check Service Id file' => 'Vérifier le fichier d\'identification du service',
  ...
  'Client ID' => 'Client ID',
  'Click Continue and Download the file in device named AuthKey_ID.p8 (Store it safely and it is used for push notification)' => 'Cliquez sur Continuer et téléchargez le fichier sur l\'appareil nommé AuthKey ID.p8 (stockez-le en toute sécurité et il est utilisé pour la notification push)',
  ...
  'Change status to handover' => 'Changer le statut en transfert',
  ...
  'Mart' => 'Marché',
  'Please select minimum' => 'Veuillez sélectionner un minimum',
);